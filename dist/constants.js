...
exports.MAX_RETRIES = parseInt(process.env.MAX_RETRIES || '3'); // Default to 3 retries if not set
...
exports.ADDITIONAL_SECONDS = parseInt(process.env.ADDITIONAL_SECONDS || "20"); // 20 seconds past the interval
