...
export const MAX_RETRIES = parseInt(process.env.MAX_RETRIES || '5'); // Default to 3 retries if not set
...
export const ADDITIONAL_SECONDS = parseInt(process.env.ADDITIONAL_SECONDS || "40"); // 20 seconds past the interval
