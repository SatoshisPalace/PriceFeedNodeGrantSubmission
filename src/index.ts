...
import { MarketChartRangeHandler } from './api/coin-gecko/MarketChartRangeHandler';
...
async function main() {
    ...
    const historicalDataHandler = new CryptoCompareHistoricalDataHandler('BTC', 'USD');
    try {
        const data = await historicalDataHandler.getHistoricalMinuteData('1', '1714441970');
